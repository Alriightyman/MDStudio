...
namespace MDStudioPlus.Behaviors
{
    ...
    public static class LayoutSerializer
    {
        ...
        private static readonly DependencyProperty LoadLayoutCommandProperty =
            ...
            typeof(ICommand),
            typeof(LayoutSerializer),
            new PropertyMetadata(null, LayoutSerializer.OnLoadLayoutCommandChanged));
        ...
        private static readonly DependencyProperty SaveLayoutCommandProperty =
            ...
            typeof(ICommand),
            typeof(LayoutSerializer),
            new PropertyMetadata(null, LayoutSerializer.OnSaveLayoutCommandChanged));
        #endregion fields
        ...
        private static void OnFrameworkElement_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            ICommand loadLayoutCommand = LayoutSerializer.GetLoadLayoutCommand(frameworkElement);
        ...
        private static void OnSaveLayoutCommandChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            Window window = Window.GetWindow(framworkElement);
            window.Closing -= OnFrameworkElement_Saved;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void OnFrameworkElement_Saved(object sender, CancelEventArgs e)
        {
            
            DockingManager frameworkElement = sender is MainWindow ? ((MainWindow)sender).DockManager : null;

            // Sanity check just in case this was somehow send by something else
            if (frameworkElement == null)
                return;

            ICommand SaveLayoutCommand = LayoutSerializer.GetSaveLayoutCommand(frameworkElement);
